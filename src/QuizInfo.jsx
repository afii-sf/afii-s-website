                ...
                <section className="w-100 d-flex flex-column justify-content-center align-items-center p-2 info">
                    <div className="container">
                        <div className="rule d-flex align-items-md-center">
                            <img src="https://github.com/Ekene-Azubuko/afii/blob/main/src/images/anonymous.png?raw=true" alt="img" height="30" className="d-block"/>
                        ...
                        <div className="rule d-flex align-items-md-center">
                            ...
                            <img src="https://github.com/Ekene-Azubuko/afii/blob/main/src/images/skip.png?raw=true" alt="img" height="30" className="d-block"/>
                            <div className="rule-instruction mx-3">
                        ...
                        <div className="rule d-flex align-items-md-center">
                            ...
                            <img src="https://github.com/Ekene-Azubuko/afii/blob/main/src/images/return.png?raw=true" alt="img" height="30" className="d-block"/>
                            <div className="rule-instruction mx-3">
                        ...
                        <div className="rule d-flex align-items-md-center">
                            ...
                            <img src="https://github.com/Ekene-Azubuko/afii/blob/main/src/images/delete.png?raw=true" alt="img" height="30" className="d-block"/>
                            <div className="rule-instruction mx-3">
